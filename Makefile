SRC = main.c  parsing_stock.c parsing_utils.c check_map.c check_color_texture.c bonus/draw_mini_map.c mlx_utils.c data_init.c intersectionxy.c wall_projections.c
